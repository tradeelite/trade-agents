"""Deployment script for Trade Agent to Vertex AI Agent Engine."""
...
def create() -> None:
    """Creates an agent engine for Trade Agent."""
    ...
    remote_agent = agent_engines.create(
        ...
        requirements=[
            "google-adk==1.26.0",
            "google-cloud-aiplatform[agent_engines] (>=1.136.0)",
            "google-genai (>=1.5.0,<2.0.0)",
            "pydantic (>=2.10.6,<3.0.0)",
            "httpx (>=0.27.0)",
        ],
        extra_packages=["./trade_agent"],
    )
